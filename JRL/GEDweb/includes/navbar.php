<div class="usernav">
    ...
    <ul> <!-- Ensure there are no enter escape characters.-->
        <li><a href="requests.php">Friend Requests (<?php echo $row['count'] ?>)</a></li><li><a href="profile.php">Profile</a></li><li><a href="friends.php">Friends</a></li><li><a href="home.php">Home</a><a href="http://localhost/chat%20ged%20test%203/ChatApp%20-%20CodingNepal/users.php">GED Chat</a></li></li><li><a href="logout.php">Log Out</a></li>
